package com.ranjeet.qrcodescanner;
...
import com.ranjeet.qrcodescanner.camera.CameraManager;
import com.ranjeet.qrcodescanner.decode.CaptureActivityHandler;
import com.ranjeet.qrcodescanner.decode.DecodeImageCallback;
import com.ranjeet.qrcodescanner.decode.DecodeImageThread;
import com.ranjeet.qrcodescanner.decode.DecodeManager;
import com.ranjeet.qrcodescanner.decode.InactivityTimer;
import com.ranjeet.qrcodescanner.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private final String GOT_RESULT = "com.ranjeet.qrcodescanner.got_qr_scan_relult";
    private final String ERROR_DECODING_IMAGE = "com.ranjeet.qrcodescanner.error_decoding_image";
